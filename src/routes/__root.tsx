 ...
 * - A `<main id="main">` area containing the child {@link Outlet}.
 *
 * A {@link NuqsAdapter} wraps the entire layout so that URL query parameters
 * are available to both header and page-level components.
 *
